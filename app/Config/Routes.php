...
$routes->add('AdminController/createuser','AdminController::createAccount');
$routes->add('AdminController/createrole','AdminController::createRole');
$routes->add('AdminController/createcategory','AdminController::createCategory');
$routes->add('AdminController/createsubcategory','AdminController::createSubCategory');
$routes->add('AdminController/createproduct','AdminController::createProduct');
